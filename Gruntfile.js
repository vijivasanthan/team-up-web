(function()
{
	...
	module.exports = function(grunt)
	{
		...
		grunt.registerTask('serve', 'start a web server with extras', function(target)
		{
			...
			return grunt.task.run(['clean:server', 'babel:dist', 'concurrent:server', 'autoprefixer', 'configureProxies:server', 'connect:livereload', 'watch']);
		});

		grunt.registerTask('lala', ['babel:dist']);
