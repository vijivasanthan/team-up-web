module.exports = function (karma)
{
  ...
  karma.set({
    ...
    files: [
      ...
      {pattern: 'app/vendors/angular-sanitize/angular-sanitize.min.js', included: false },
      ...
      {pattern: 'app/vendors/Chart.js/Chart.js', included: false },
      {pattern: 'app/vendors/angular-chart/angular-chart.js', included: false },
      {pattern: 'app/vendors/lodash/dist/lodash.min.js', included: false },
      {pattern: 'app/vendors/angular-cookie/angular-cookie.js', included: false },
