...
require.config(
  {
    ...
    paths: {
      ...
      'seiyria-bootstrap-slider': '../vendors/seiyria-bootstrap-slider/dist/bootstrap-slider.min',
      lawnchair: '../vendors/lawnchair/src/Lawnchair',
      'chart': '../vendors/Chart.js/Chart',
      "angular-chart": "../vendors/angular-chart.js/angular-chart",
      ...
      'momentrange': '../vendors/moment-range/dist/moment-range.min',
    ...
    shim: {
      ...
      "angular-chart": { deps: ['angular', 'chart'],  exports: 'angular' },
      bootstrap: { deps: ['jquery'], exports: 'jQuery' },
      'seiyria-bootstrap-slider': { deps: ['jquery'], exports: 'jQuery' },
      lawnchair: { deps: [], exports: 'Lawnchair' },
      'ladda': { deps: [],  exports: 'Ladda'},
      dom: { deps: ['lawnchair'], exports: 'Lawnchair' },
      vis: { deps: ['moment'], exports: 'vis'},
...
require(
  [
    ...
    'controllers/team-telephone/create',
    ...
    'controllers/team-telephone/stats',
