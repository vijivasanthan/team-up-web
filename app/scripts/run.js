	...
	function(app, locals, config)
	{
		...
		app.run(
				function($rootScope, $location, $timeout, Session, Store, $window, $filter, Teams, Offline, States, Browsers,
				         ...
				         moment, tmhDynamicLocale, ipCookie, Version, SessionCount)
				{
					...
					//	SessionCount.substract();
					//
					//
					//	console.error("before closing ->");
					//	return '';
					//};

					window.onunload = function()
					{
						//localStorage.setItem("teamtelefoon_sessions", 0);
						//SessionCount.substract();
					};
						       ...
						       .then(function(versionInfo)
						             {
							             ...
							             if( versionInfo )
							             {
								             ...
								             $rootScope.backEndVersion.title = Version.setVersionToolTip({
									                                                                         app: "Back-end",
								             ...
								             try
								             {
									             ...
									             $rootScope.frontEndVersion.title = Version.setVersionToolTip({
										                                                                          app: "Front-end",
