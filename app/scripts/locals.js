    ...
    ui: {
      en: {
        ...
        dashboard: {
          ...
          loadingPie: 'Loading pie diagrammes...',
        ...
        agenda: {
          ...
          notachieve: 'Not archived',
          legendaLabels: {
            morePeople: 'More people',
            enoughPeople: 'Enough people',
          ...
          statPeopleEven: 'exactly enough mensen',
          ...
          rangeInfoTotalSelectedDays: 'Totale selected days: ',
          rangeInfoTime: 'Time: ',
          rangeInfoWeekNumber: 'Weeknumber: ',
          rangeInfoMonth: 'Month: ',
          rangeInfoTotalDays: ', Total number of days: ',
          query: 'There are some problems with synchronising the agenda. Could you please refresh your browser to get the latest information.',
          ...
          notAuth: 'It is not possible to change someone else his/her planning, accept as coordinator. As coordinator it is possible to change someone else his/her planning by clicking on their name in the list. You will be navigated to another page where you can change the planning of the member you selected.',
          the: 'The',
        ...
        planboard: {
          ...
          noClients: 'There are no clients in this clientgroup.',
          add: 'Add',
          del: 'Delete',
          change: 'Change',
          setWish: 'Set wish',
        ...
        profile: {
          ...
          refreshing: 'Refreshing profile informatio...',
          ...
          pleaseFill: 'Please fill in all fields with valide information!',
        ...
        teamup: {
          ...
          undefinedTeamMember: 'Undefined teammember',
          ...
          newMember: 'New teammember',
          noMembersFound: 'No members found with given search criteria.',
          name: 'Name',
          role: 'Role',
          phone: 'Telephone',
          street: 'Street',
          ...
          teams_Cap: 'Teams',
          noTeamNameFound: 'Teamname unknown',
          noTeam: 'No team',
          ...
          time: 'Time',
          duration: 'Duration',
          coordinatorNoTeam: 'It seems that you are not in a team. Assign yourself to a team.',
          teamMemberNoTeam: 'It seems that you are not in a team. Contact a coordinator.',
          ...
          confirms: {
            ...
            deleteMemberFromTeam: 'Are you sure you want to delete the member from all teams? Watch out: Someone who is not in a team, can not use Teamup. ',
            deleteMemberTitle: 'Delete teammember',
            ...
            addTeamMemberCodeAsPhone: 'There is entered a pincode that does not match with the last four digits of your telephone number ,',
          ...
          errorCode: {
            '1': 'Unknown error',
            '2': 'The domain agent could not be found’. Logging in again could fix this issue.',
            '3': 'This member should have the coördinator role, before a new team is created',
            '4': 'An agent ID can only exist of alphanumeric characters, underscores and dashes',
            '5': 'Can not pars the JSON body',
            ...
            '11': 'This member should have the coördinator role, before a new team is created',
            '12': 'The team agent could not be created',
            '13': 'The uuid parameter and the uuid in the payload do not match',
            '14': 'A member with the same username already exists',
            ...
            '19': 'The inserted old password does not match with the present one',
            '20': 'This member should have the coördinator role before the password of another member can be changed',
        ...
        options: {
          ...
          ringingTimeOut: {
            title: 'Rinkeltime',
            short: 'When the rinkeltime is long the teamembers will have more time to pick up their phone, but the total waitingtime for clients can be longer when many teammembers are signed on.',
            long: 'When the rinkeltime is 15 seconds or more it is recommended for the teammebers to disable their personal voicemail.',
          },
          personalVoicemailPrevention: 'Personal voicemailprevention',
          personalVoicemailPreventionInfo: 'When this option is enabled, teammebers will first get the question of they want to take this call from a client . By enabling this option it can be prevented that a client is connected with a members personal voicemail.',
        ...
        task: {
          ...
          filltheTime: 'Fill in start- and endtime in for the task.',
          startTimeEmpty: 'Fill startdate and -time in.',
          endTimeEmpty: 'Fill in enddate and -time in.',
          planTaskInFuture: 'U can’t plan a task in the past. Select a start- and endtime in the future.',
          startLaterThanEnd: 'Start time most be before endtime.',
        ...
        validation: {
          phone: {
            ...
            notValidOnSubmit: 'Please fill in at least a valid phone number to save.',
          ...
          pincode: {
            exists: 'Please choose a different pincode. This pincode already exist!'
          },
          password: {
            ...
            {
              return ' and can contain a maximum of ' + chars + ' tekens(s) te bestaan'
            },
