            ...
            Aggs.query(
              ...
              function (results)
              {
                ...
                if (results.length > 1)
                {
                  ...
                  angular.forEach(
                    weeks.current.data, function (slot, index)
                    {
                  ...
                  // add to shortages
                  angular.forEach(
                    weeks.next.data, function (slot, index)
                    {
          ...
          var preloader = {
            ...
            count: function ()
            {
              $rootScope.app.preloader.count = Math.abs(
                Math.floor(
                    $rootScope.app.preloader.count + (
                    100 / $rootScope.app.preloader.total)));
            }
          };
